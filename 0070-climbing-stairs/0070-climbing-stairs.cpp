class Solution {
public:
    // Recursive function with memoization to compute the number of ways to
    // climb stairs
    ...
    int climbStairs(int n) {
        ...
        //     for (int i = 2; i <= n; ++i) {
        //         int current = prev1 + prev2; // Number of ways to climb i
        //         stairs prev2 = prev1; // Update prev2 to the previous step
